      ...
      <section className="flex-1 min-w-0 p-8 max-md:w-full max-md:p-4 max-md:pt-20 max-md:overflow-x-hidden">
        ...
        <div className="hidden max-md:block w-full max-w-full overflow-hidden">
          ...
          {loading ? (
            ...
            <>
              {/* GREETING CARD */}
              <div className="mb-7 w-full max-w-full overflow-hidden rounded-3xl bg-[#6f8f5f] p-6 text-white shadow">
                <div className="flex items-center justify-between gap-4">
                  <div className="min-w-0">
                    ...
                    <p className="mt-2 text-sm leading-relaxed text-white/85">
                      Kelola penjualan, stok, dan laporan Matchaboy.
                    </p>
                  </div>
              ...
              <div className="mb-4 flex items-center justify-between">
                ...
                <button
                  onClick={fetchDashboard}
                  className="text-sm font-semibold text-[#5f7f4f]"
                >
                  Refresh
                </button>
              </div>
              ...
              {/* PRODUK TERLARIS */}
              <div className="mb-6 w-full rounded-3xl bg-white p-5 shadow border border-[#dfe8d2]">
                <h3 className="mb-4 font-bold text-[#2f3a25]">
                  Produk Terlaris
                </h3>
                ...
                {topProducts.length === 0 ? (
                  ...
                  <div className="space-y-3">
                    {topProducts.slice(0, 5).map((item, index) => (
                      <div
                        key={item.productId}
                        className="flex w-full items-center justify-between gap-3 rounded-2xl border border-[#eef2e8] p-4"
                      >
                        <div className="flex min-w-0 items-center gap-3">
                          ...
                          <div className="min-w-0">
                            <p className="truncate font-semibold text-[#2f3a25]">
                              {item.name}
                            </p>
                ...
                {transactions.length === 0 ? (
                  ...
                  <div className="space-y-3">
                    {transactions.map((trx) => (
                      <div
                        key={trx.id}
                        className="rounded-2xl border border-[#eef2e8] p-4"
                      >
                        <div className="flex items-center justify-between gap-3">
                          <div className="min-w-0">
                            <p className="text-sm font-bold text-[#2f3a25]">
...
function MobileSuggestionCard({
  ...
  return (
    <button
      onClick={onClick}
      className="w-full max-w-full rounded-3xl bg-white p-4 text-left shadow border border-[#dfe8d2]"
    >
...
function MobileShortcut({
  ...
  return (
    <button
      onClick={onClick}
      className="min-h-[118px] rounded-3xl bg-white p-4 text-center shadow border border-[#dfe8d2]"
    >
